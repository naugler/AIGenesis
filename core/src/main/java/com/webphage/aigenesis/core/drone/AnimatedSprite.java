...
public class AnimatedSprite extends Group {
     ...
     * @param rows The animation texture rows.
     * @param cols The animation texture rows.
     * @param frameDuration The animation frame duration.
     * @param looping Flag to indicate we should loop the animation.
     */
